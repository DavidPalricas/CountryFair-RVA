...
export function GameScreen() {
    return (
        <div className="game-screen">
            ...
            <Canvas>
                <Camera position={[1, 1.8, 18]} lookAt={[0, 1.5, 0]} />
                ...
                <MiniGameTent position={[-4.2, 0.05, 13]} rotation={[0, Math.PI / 6, 0]} type="fishing" />
                ...
                <MiniGameTent position={[3.6, 0.05, 13]} rotation={[0,- Math.PI/8, 0]} type="duckgame" />
